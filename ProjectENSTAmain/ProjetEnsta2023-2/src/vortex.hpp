...
namespace Simulation
{
    ...
    public:
        ...
        void setVortex( std::size_t t_index, double  t_center_x, double  t_center_y, double t_intensity )
        {
            assert(t_index < numberOfVortices() );
            assert(t_intensity != 0);
            m_centers_and_intensities[3*t_index+0] = t_center_x;
            m_centers_and_intensities[3*t_index+1] = t_center_y;
            m_centers_and_intensities[3*t_index+2] = t_intensity;           
        }
