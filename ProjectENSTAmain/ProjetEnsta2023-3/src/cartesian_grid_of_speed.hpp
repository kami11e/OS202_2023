...
namespace Numeric
{
    ...
    public:
        ...
        void subUpdateVelocitySubField( Simulation::Vortices const& t_vortices, int rank, std::size_t subHeight);
        void SetVelocityFieldVal(  std::vector<double>const& t_grid);
